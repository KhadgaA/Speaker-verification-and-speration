...
#SBATCH --output=kb_process_%j.log 	# Standard output and error log
date;hostname;pwd
...
python structure.py "/scratch/data/m23csa003/kathbadh/kb_data_clean_m4a" "/scratch/data/m23csa003/kathbadh/kb_data_clean_wav" telugu &> process_prog.txt